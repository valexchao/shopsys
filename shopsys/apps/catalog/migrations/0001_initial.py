# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-08 15:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_bestseller', models.BooleanField(default=False, verbose_name='设为畅销')),
                ...
                ('meta_description', models.CharField(help_text='Meta描述标签', max_length=255, verbose_name='Meta描述')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
